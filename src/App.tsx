...
import { ModelSyncModal } from './components/ModelSyncModal'
...
function AppShell() {
  ...
  const [showModelSync, setShowModelSync] = useState(false)
  ...
  return (
    <div className="app-shell">
      ...
      {showModelSync && <ModelSyncModal onClose={() => setShowModelSync(false)} />}
      ...
      <Sidebar
        ...
        onModelSync={() => setShowModelSync(true)}
      />
